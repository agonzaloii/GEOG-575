$(document).ready(function() {
	//center slippy map on Asia Region
	var cities;
	var map = L.map('map', {
			center: [ 15.48,114.40],
			zoom: 4,
	...
	//load data to be used in the map
	$.getJSON("data/city-data2.json")
		.done(function(data) {
	...
	//symbolize data using propsymbols
	...
	function createLegend(min, max) {
		...
		legend.onAdd = function(map) {
			...
			$(legendContainer).append("<h2 id='legendTitle'>Changesets per Month</h2>");
